...
class CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::_stat_CLASS_ptr_Global = NULL;
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot0_CLASS_DECLARE_WriteEnableForThreadsAt_STACK()
    {
        std::cout << "entered boot0_CLASS_DECLARE_WriteEnableForThreadsAt_STACK()" << std::endl;

        std::cout << "exiting boot0_CLASS_DECLARE_WriteEnableForThreadsAt_STACK()" << std::endl;
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot1_CLASS_DEFINE_WriteEnableForThreadsAt_STACK()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_STACK()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot0_REG_DECLARE_WriteEnableForThreadsAt_STACK()
    {
        std::cout << "entered boot0_REG_DECLARE_WriteEnableForThreadsAt_STACK()" << std::endl;

        std::cout << "exiting boot0_REG_DECLARE_WriteEnableForThreadsAt_STACK()" << std::endl;
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot1_REG_DEFINE_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot3_REG_INITIALISE_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::dyn_app_FUNCT_write_End(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::dyn_app_FUNCT_write_Start(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj, uint8_t coreId)
    {
    ...
    CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::dyn_CLASS_get_ptr_Global()
    {
        return stat_CLASS_get_ptr_Global();
    }
    CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::dyn_CLASS_get_ptr_WriteEnable_Control()
    {
    ...
    CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK::stat_CLASS_get_ptr_WriteEnable_Control()
    {
