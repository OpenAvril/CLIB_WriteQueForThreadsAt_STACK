#ifndef CLIB_WriteEnableForThreadsAt_ClientInputSend_WRITEENABLEFORTHREADSAT_ClientInputSend_CONTROL_H
#define CLIB_WriteEnableForThreadsAt_ClientInputSend_WRITEENABLEFORTHREADSAT_ClientInputSend_CONTROL_H
#include <cstdint>
#include <list>
extern "C"
{
    ...
    {
        class WriteEnableForThreadsAt_ClientInputSend_Control
        {
        public:
            WriteEnableForThreadsAt_ClientInputSend_Control();
            ~WriteEnableForThreadsAt_ClientInputSend_Control();
            static void boot0_CLASS_DECLARE_WriteEnableForThreadsAt_ClientInputSend_Control();
            static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_ClientInputSend_Control();
            static void boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_ClientInputSend_Control();
            static void boot0_REG_DECLARE_WriteEnableForThreadsAt_ClientInputSend_Control();
            void boot1_REG_DEFINE_WriteEnableForThreadsAt_ClientInputSend_Control(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_ClientInputSend_Control(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            void boot3_REG_INITIALISE_WriteEnableForThreadsAt_ClientInputSend_Control(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_ClientInputSend_Control(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            void app_FUNCT_writeEnable_Activate(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeEnable_SortQue(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            void app_FUNCT_writeEnable_Request(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeQue_Update(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            ...
            void dynamicStagger(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj, uint8_t coreId);
            void writeEnable_ShiftQueValues(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj, uint8_t coreId_A, uint8_t coreId_B);
        private:
            ...
            static void stat_REG_boot2_SUBSTANTIATE_WriteACTIVE_Count_For_ThreadId(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteIDLE_Count_For_ThreadId(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteWAIT_Count_For_ThreadId(class WriteEnableForThreadsAt_ClientInputSend_Framework* obj);
...
#endif //CLIB_WriteEnableForThreadsAt_ClientInputSend_WRITEENABLEFORTHREADSAT_ClientInputSend_CONTROL_H
