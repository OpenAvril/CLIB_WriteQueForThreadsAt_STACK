...
#include <iostream>
#include <ostream>
    CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Control* CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::_stat_CLASS_ptr_WriteEnable__Control = NULL;
    CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::WriteEnableForThreadsAt_ClientInputSend__App()
    {
        CLASS_boot0_DECLARE_WriteEnableForThreadsAt_ClientInputSend();
        CLASS_boot1_DEFINE_WriteEnableForThreadsAt_ClientInputSend();
        CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ClientInputSend();
    }
    CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::~WriteEnableForThreadsAt_ClientInputSend__App()
    {
        delete _stat_CLASS_ptr_WriteEnable__Control;
    }
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::CLASS_boot0_DECLARE_WriteEnableForThreadsAt_ClientInputSend()
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::CLASS_boot1_DEFINE_WriteEnableForThreadsAt_ClientInputSend()
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ClientInputSend()
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::REG_boot0_DECLARE_WriteEnableForThreadsAt_ClientInputSend()
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::REG_boot1_DEFINE_WriteEnableForThreadsAt_ClientInputSend(CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Framework* obj)
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ClientInputSend(CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Framework* obj)
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::REG_boot3_INITIALISE_WriteEnableForThreadsAt_ClientInputSend(CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Framework* obj)
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_ClientInputSend(CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::dyn_APP_FUNCT_write_End(CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::dyn_APP_FUNCT_write_Start(CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::stat_CLASS_boot1_DEFINE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = NULL;
    }

    void CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::stat_CLASS_boot3_INITIALISE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = new class CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Control();
        while (stat_CLASS_get_ptr_WriteEnable__Control() == NULL) {}
    }
    CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__Control* CLIBWriteQueAtClientInputSend::WriteEnableForThreadsAt_ClientInputSend__App::stat_CLASS_get_ptr_WriteEnable__Control()
    {
