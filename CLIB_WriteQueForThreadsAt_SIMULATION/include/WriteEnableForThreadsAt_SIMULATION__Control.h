...
namespace CLIBWriteQueAtSIMULATION
{
    ...
    private:
        static bool* _stat_REG_ptr_flag_WriteEnableForThreadsAt_SIMULATION__flag_Control__isCurrentThreadRELEASED;
        ...
        static bool stat_REG_get_flag_WriteEnableForThreadsAt_SIMULATION__flag_Control__isCurrentThreadRELEASED();
        ...
        static void stat_REG_set_flag_WriteEnableForThreadsAt_SIMULATION__flag_Control__isCurrentThreadRELEASED(bool flagState);
        ...
        static void stat_REG_set_flag_WriteEnableForThreadsAt_SIMULATION__Control__praisingWrite(bool newFlag);
    };
}
#endif
