...
{
    stat_REG_dyn_REG_set_flag_WriteEnableForThreadsAt_ConditionCode__Control__praisingWrite(newBoolValue);
}
...
void CLIBWriteQueAtConditionCode::WriteEnableForThreadsAt_ConditionCode__Control::stat_REG_dyn_REG_set_flag_WriteEnableForThreadsAt_ConditionCode__Control__praisingWrite(bool newFlag)
{
