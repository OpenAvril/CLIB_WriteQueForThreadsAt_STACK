...
// public.
void* CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__App_FUNCT_generate_Program()
{
...
unsigned char* CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__App_FUNCT_get_flag_isPGM_INSTANTIATED()
{
...
void CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__App_FUNCT_terminate_Program()
{
...
void CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_ServerOutputSend__dyn_APP_FUNCT_Calc_IsAllINSTANTIATED()
{
...
void CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__stat_CLASS_boot1_DEFINE_Framework()
{
	_stat_REG_ptr_Framework_WriteEnableForThreadsAt_STACK = NULL;
}
void CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__stat_CLASS_boot3_INITIALISE_Framework()
{
...
CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Framework* CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__stat_CLASS_get_ptr_Framework()
{
	return _stat_REG_ptr_Framework_WriteEnableForThreadsAt_STACK;
}
void CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__stat_REG_boot1_DEFINE_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED()
{
	_stat_REG_flag_CLIB_WriteEnableForThreadsAt_STACK__isMemberFunctionINSTANTIATED = NULL;
}
void CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED()
{
...
void CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__stat_REG_boot3_INITIALISE_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED()
{
	for (uint8_t index = 0; index < sizeof(*CLIB_WriteEnableForThreadsAt_STACK__stat_REG_get_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED()); index++)
	{
		_stat_REG_flag_CLIB_WriteEnableForThreadsAt_STACK__isMemberFunctionINSTANTIATED[index] = true;
...
bool* CLIBWriteQueAtSTACK::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_STACK__stat_REG_get_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED()
{
