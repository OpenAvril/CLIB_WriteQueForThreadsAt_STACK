...
#include <iostream>
#include <ostream>
    CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Control* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::_stat_CLASS_ptr_WriteEnable__Control = NULL;
    CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::WriteEnableForThreadsAt_STACK__App()
    {
        CLASS_boot0_DECLARE_WriteEnableForThreadsAt_STACK();
        CLASS_boot1_DEFINE_WriteEnableForThreadsAt_STACK();
        CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_STACK();
    }
    CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::~WriteEnableForThreadsAt_STACK__App()
    {
        delete _stat_CLASS_ptr_WriteEnable__Control;
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::CLASS_boot0_DECLARE_WriteEnableForThreadsAt_STACK()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::CLASS_boot1_DEFINE_WriteEnableForThreadsAt_STACK()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_STACK()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::REG_boot0_DECLARE_WriteEnableForThreadsAt_STACK()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::REG_boot1_DEFINE_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::REG_boot3_INITIALISE_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_STACK(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::dyn_APP_FUNCT_write_End(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::dyn_APP_FUNCT_write_Start(CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::stat_CLASS_boot1_DEFINE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = NULL;
    }

    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::stat_CLASS_boot3_INITIALISE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = new class CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Control();
        while (stat_CLASS_get_ptr_WriteEnable__Control() == NULL) {}
    }
    CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__Control* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK__App::stat_CLASS_get_ptr_WriteEnable__Control()
    {
