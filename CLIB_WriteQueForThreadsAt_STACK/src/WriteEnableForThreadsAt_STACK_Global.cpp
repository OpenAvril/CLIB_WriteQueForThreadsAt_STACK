...
#include <cstring>
#include <iostream>
    std::array<bool,2>* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::_stat_REG_CONST_2bitFLAG_IDLE;
    std::array<bool,2>* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::_stat_REG_CONST_2bitFLAG_WAIT;
    std::array<bool,2>* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::_stat_REG_CONST_2bitFLAG_WRITE;
    uint8_t* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::_stat_REG_ptr_number_Of_Implemented_Threads;
// public.
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::boot1_REG_DEFINE_WriteEnableForThreadsAt_STACK_Global()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_STACK_Global()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::boot3_REG_INITIALISE_WriteEnableForThreadsAt_STACK_Global()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_STACK_Global()
    {
        //if thread primed and system initialised, exit, else wait.
    }
    std::array<bool,2> CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::dyn_REG_get_ptr_CONST_2bitFLAG_IDLE()
    {
        return *stat_REG_get_ptr_CONST_2bitFLAG_IDLE();
    }
    std::array<bool,2> CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::dyn_REG_get_ptr_CONST_2bitFLAG_WAIT()
    {
        return *stat_REG_get_ptr_CONST_2bitFLAG_WAIT();
    }
    std::array<bool,2> CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::dyn_REG_get_ptr_CONST_2bitFLAG_WRITE()
    {
...
// private.
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot1_DEFINE_CONST_2bitFLAG_IDLE()
    {
        _stat_REG_CONST_2bitFLAG_IDLE = nullptr;
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot1_DEFINE_CONST_2bitFLAG_WAIT()
    {
        _stat_REG_CONST_2bitFLAG_WAIT = nullptr;
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot1_DEFINE_CONST_2bitFLAG_WRITE()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot2_SUBSTANTIATE_CONST_2bitFLAG_IDLE()
    {
        *_stat_REG_CONST_2bitFLAG_IDLE  = {true, true};
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot2_SUBSTANTIATE_CONST_2bitFLAG_WAIT()
    {
        *_stat_REG_CONST_2bitFLAG_WAIT  = {true, true};
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot2_SUBSTANTIATE_CONST_2bitFLAG_WRITE()
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot3_INITIALISE_CONST_2bitFLAG_IDLE() {
        *_stat_REG_CONST_2bitFLAG_IDLE = {false, false};
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot3_INITIALISE_CONST_2bitFLAG_WAIT()
    {
        *_stat_REG_CONST_2bitFLAG_WAIT = {true, false};
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot3_INITIALISE_CONST_2bitFLAG_WRITE()
    {
        *_stat_REG_CONST_2bitFLAG_WRITE = {true, true};
    }
    ...
    std::array<bool,2>* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_get_ptr_CONST_2bitFLAG_IDLE()
    {
        return _stat_REG_CONST_2bitFLAG_IDLE;
    }
    std::array<bool,2>* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_get_ptr_CONST_2bitFLAG_WAIT()
    {
        return _stat_REG_CONST_2bitFLAG_WAIT;
    }
    std::array<bool,2>* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_get_ptr_CONST_2bitFLAG_WRITE()
    {
