...
std::array<std::array<bool, 2>, 3>* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::_stat_REG_CONST_2bitFLAG_STATE;
...
uint8_t* CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::_stat_REG_ptr_writeCycle_Try_ThreadId_Index;
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::boot1_REG_DEFINE_WriteEnableForThreadsAt_STACK_Control(WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_STACK_Control(WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::boot3_REG_INITIALISE_WriteEnableForThreadsAt_STACK_Control(WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_STACK_Control(WriteEnableForThreadsAt_STACK_Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::app_FUNCT_writeEnable_Activate(WriteEnableForThreadsAt_STACK_Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::app_FUNCT_writeEnable_SortQue(WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Control::app_FUNCT_writeEnable_Request(WriteEnableForThreadsAt_STACK_Framework* obj, uint8_t coreId)
    {
