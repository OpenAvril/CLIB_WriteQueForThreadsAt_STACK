#ifndef CLIB_WriteEnableForThreadsAt_STACK_CLIB_WRITEENABLEFORTHREADSAT_STACK_H
#define CLIB_WriteEnableForThreadsAt_STACK_CLIB_WRITEENABLEFORTHREADSAT_STACK_H
extern "C"
{
    namespace CLIBWriteQueAtSTACK
    {
        ...
        private:
            ...
            static void stat_REG_boot1_DEFINE_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED();
            static void stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED();
            static void stat_REG_boot3_INITIALISE_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED();
            static bool* stat_REG_get_CLIBLaunchQueAtSTACK_isFlagINSTANTIATED();
        };
    }
}
#endif
