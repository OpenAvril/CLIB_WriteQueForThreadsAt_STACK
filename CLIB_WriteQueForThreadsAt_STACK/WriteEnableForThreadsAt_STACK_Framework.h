...
namespace OpenAvrilCLIBWriteEnableForThreadsAtSTACK
{
    ...
    public:
        ...
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_STACK_Framework();
        ...
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_STACK_Framework();
        void boot1_REG_DEFINE_WriteEnableForThreadsAt_STACK_Framework(class WriteEnableForThreadsAt_STACK_Framework* obj);
        void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_STACK_Framework(class WriteEnableForThreadsAt_STACK_Framework* obj);
        void boot3_REG_INITIALISE_WriteEnableForThreadsAt_STACK_Framework(class WriteEnableForThreadsAt_STACK_Framework* obj);
        void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_STACK_Framework(class WriteEnableForThreadsAt_STACK_Framework* obj);
