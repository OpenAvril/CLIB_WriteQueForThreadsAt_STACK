...
extern "C"
{
    namespace CLIBWriteQueAtSIMULATION
    {
        ...
        private:
            ...
            static void CLIB_WriteEnableForThreadsAt_SIMULATION_InputSamples__dyn_APP_FUNCT_Calc_IsAllINSTANTIATED();
            ...
            static void CLIB_WriteEnableForThreadsAt_SIMULATION_InputSamples__stat_REG_boot1_DEFINE_CLIBLaunchQueAtSIMULATION_isFlagINSTANTIATED();
            static void CLIB_WriteEnableForThreadsAt_SIMULATION_InputSamples__stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtSIMULATION_isFlagINSTANTIATED();
            static void CLIB_WriteEnableForThreadsAt_SIMULATION_InputSamples__stat_REG_boot3_INITIALISE_CLIBLaunchQueAtSIMULATION_isFlagINSTANTIATED();
            static bool* CLIB_WriteEnableForThreadsAt_SIMULATION_InputSamples__stat_REG_get_CLIBLaunchQueAtSIMULATION_isFlagINSTANTIATED();
        };
    }
}
#endif
