...
#include <iostream>
#include <ostream>
    CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__Control* CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::_stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control = NULL;
    CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::WriteEnableForThreadsAt_SIMULATION_InputSamples__App()
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::CLASS_boot0_DECLARE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App()
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App()
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App()
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::REG_boot0_DECLARE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App()
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::REG_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App(WriteEnableForThreadsAt_SIMULATION_InputSamples__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App(WriteEnableForThreadsAt_SIMULATION_InputSamples__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::REG_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App(WriteEnableForThreadsAt_SIMULATION_InputSamples__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_SIMULATION_InputSamples__App(WriteEnableForThreadsAt_SIMULATION_InputSamples__Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::dyn_APP_FUNCT_write_End(WriteEnableForThreadsAt_SIMULATION_InputSamples__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::dyn_APP_FUNCT_write_Start(WriteEnableForThreadsAt_SIMULATION_InputSamples__Framework* obj, uint8_t coreId)
    {
    ...
    CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__Control* CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::dyn_CLASS_get_ptr_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control()
    {
        return stat_CLASS_get_ptr_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control();
    }

    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control()
    {
        _stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control = NULL;
    }

    void CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::stat_CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control()
    {
        _stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control = new class CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__Control();
        while (stat_CLASS_get_ptr_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control() == NULL) {}
    }
    CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__Control* CLIBWriteQueAtSIMULATION_InputSamples::WriteEnableForThreadsAt_SIMULATION_InputSamples__App::stat_CLASS_get_ptr_WriteEnableForThreadsAt_SIMULATION_InputSamples__App__Control()
    {
