#ifndef CLIB_WriteQueForThreadAt_InputPerihperalSamples_WriteQueForThreadAt_InputPerihperalSamples_CONTROL_H
#define CLIB_WriteQueForThreadAt_InputPerihperalSamples_WriteQueForThreadAt_InputPerihperalSamples_CONTROL_H
#include <cstdint>
#include <list>
extern "C"
{
    ...
    {
        class WriteQueForThreadAt_InputPerihperalSamples_Control
        {
        public:
            WriteQueForThreadAt_InputPerihperalSamples_Control();
            ~WriteQueForThreadAt_InputPerihperalSamples_Control();
            static void boot0_CLASS_DECLARE_WriteQueForThreadAt_InputPerihperalSamples_Control();
            static void boot1_CLASS_DEFINE_WriteQueForThreadAt_InputPerihperalSamples_Control();
            static void boot3_CLASS_INITIALISE_WriteQueForThreadAt_InputPerihperalSamples_Control();
            static void boot0_REG_DECLARE_WriteQueForThreadAt_InputPerihperalSamples_Control();
            void boot1_REG_DEFINE_WriteQueForThreadAt_InputPerihperalSamples_Control(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            void boot2_REG_SUBSTANTIATE_WriteQueForThreadAt_InputPerihperalSamples_Control(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            void boot3_REG_INITIALISE_WriteQueForThreadAt_InputPerihperalSamples_Control(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            void boot4_PGM_INSTANTIATION_WriteQueForThreadAt_InputPerihperalSamples_Control(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            void app_FUNCT_writeEnable_Activate(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeEnable_SortQue(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            void app_FUNCT_writeEnable_Request(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeQue_Update(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            ...
            void dynamicStagger(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj, uint8_t coreId);
            void writeEnable_ShiftQueValues(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj, uint8_t coreId_A, uint8_t coreId_B);
        private:
            ...
            static void stat_REG_boot2_SUBSTANTIATE_WriteACTIVE_Count_For_ThreadId(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteIDLE_Count_For_ThreadId(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteWAIT_Count_For_ThreadId(class WriteQueForThreadAt_InputPerihperalSamples_Framework* obj);
...
#endif //CLIB_WriteQueForThreadAt_InputPerihperalSamples_WriteQueForThreadAt_InputPerihperalSamples_CONTROL_H
