#ifndef CLIB_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_CONTROL_H
#define CLIB_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_CONTROL_H
#include <cstdint>
#include <list>
extern "C"
{
    ...
    {
        class WriteQueForThreadAt_OutputGameInstanaceData_Control
        {
        public:
            WriteQueForThreadAt_OutputGameInstanaceData_Control();
            ~WriteQueForThreadAt_OutputGameInstanaceData_Control();
            static void boot0_CLASS_DECLARE_WriteQueForThreadAt_OutputGameInstanaceData_Control();
            static void boot1_CLASS_DEFINE_WriteQueForThreadAt_OutputGameInstanaceData_Control();
            static void boot3_CLASS_INITIALISE_WriteQueForThreadAt_OutputGameInstanaceData_Control();
            static void boot0_REG_DECLARE_WriteQueForThreadAt_OutputGameInstanaceData_Control();
            void boot1_REG_DEFINE_WriteQueForThreadAt_OutputGameInstanaceData_Control(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            void boot2_REG_SUBSTANTIATE_WriteQueForThreadAt_OutputGameInstanaceData_Control(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            void boot3_REG_INITIALISE_WriteQueForThreadAt_OutputGameInstanaceData_Control(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            void boot4_PGM_INSTANTIATION_WriteQueForThreadAt_OutputGameInstanaceData_Control(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            void app_FUNCT_writeEnable_Activate(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeEnable_SortQue(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            void app_FUNCT_writeEnable_Request(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeQue_Update(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            ...
            void dynamicStagger(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj, uint8_t coreId);
            void writeEnable_ShiftQueValues(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj, uint8_t coreId_A, uint8_t coreId_B);
        private:
            ...
            static void stat_REG_boot2_SUBSTANTIATE_WriteACTIVE_Count_For_ThreadId(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteIDLE_Count_For_ThreadId(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteWAIT_Count_For_ThreadId(class WriteQueForThreadAt_OutputGameInstanaceData_Framework* obj);
...
#endif //CLIB_WriteQueForThreadAt_OutputGameInstanaceData_WriteQueForThreadAt_OutputGameInstanaceData_CONTROL_H
