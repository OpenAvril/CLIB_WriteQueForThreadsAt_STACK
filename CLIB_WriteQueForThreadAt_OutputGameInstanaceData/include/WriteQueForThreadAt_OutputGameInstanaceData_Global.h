#ifndef CLIB_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_GLOBAL_H
#define CLIB_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_WRITEQUEFORTHREADAT_OUTPUTGAMEINSTANACEDATA_GLOBAL_H
#include <array>
#include <cstdint>
extern "C" {
    namespace CLIBWriteQueAtOutputGameInstanaceData
    {
        class WriteQueForThreadAt_OutputGameInstanaceData_Global
        {
        public:
            WriteQueForThreadAt_OutputGameInstanaceData_Global();
            ~WriteQueForThreadAt_OutputGameInstanaceData_Global();
            void boot1_REG_DEFINE_WriteQueForThreadAt_OutputGameInstanaceData_Global();
            void boot2_REG_SUBSTANTIATE_WriteQueForThreadAt_OutputGameInstanaceData_Global();
            void boot3_REG_INITIALISE_WriteQueForThreadAt_OutputGameInstanaceData_Global();
            void boot4_PGM_INSTANTIATION_WriteQueForThreadAt_OutputGameInstanaceData_Global();
            ...
            static void boot0_CLASS_DECLARE_WriteQueForThreadAt_OutputGameInstanaceData_Global();
            static void boot1_CLASS_DEFINE_WriteQueForThreadAt_OutputGameInstanaceData_Global();
            static void boot3_CLASS_INITIALISE_WriteQueForThreadAt_OutputGameInstanaceData_Global();
            static void boot0_REG_DECLARE_WriteQueForThreadAt_OutputGameInstanaceData_Global();
