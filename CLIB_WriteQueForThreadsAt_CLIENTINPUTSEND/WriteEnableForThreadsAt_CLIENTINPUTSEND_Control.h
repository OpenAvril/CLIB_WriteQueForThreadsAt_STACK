...
namespace OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTSEND
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_CLIENTINPUTSEND_Control();
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Control();
        ...
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Control();
