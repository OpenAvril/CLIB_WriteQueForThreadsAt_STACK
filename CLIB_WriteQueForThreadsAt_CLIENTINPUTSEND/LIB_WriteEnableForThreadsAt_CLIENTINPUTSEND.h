#ifdef LIBWRITEENABLEFORTHREADSATCLIENTINPUTSEND_EXPORTS
#define LIBWRITEENABLEFORTHREADSATSERVERINPUTSEND_API __declspec(dllexport)
#else
#define LIBWRITEENABLEFORTHREADSATSERVERINPUTSEND_API __declspec(dllimport)
#endif
extern "C"
{
	namespace OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTSEND
	{
		class LIBWRITEENABLEFORTHREADSATSERVERINPUTSEND_API CLIBWriteEnableForThreadsAtCLIENTINPUTSEND
		{
		public:
