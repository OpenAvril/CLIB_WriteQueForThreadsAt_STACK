...
{
    class WriteEnableForThreadsAt_CLIENTINPUTSEND_Global
    {
    public:
        WriteEnableForThreadsAt_CLIENTINPUTSEND_Global();
        ~WriteEnableForThreadsAt_CLIENTINPUTSEND_Global();
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global();
        static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global();
        static void boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global();
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global();
        void boot1_REG_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global(class WriteEnableForThreadsAt_CLIENTINPUTSEND_Framework* obj);
        void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global(class WriteEnableForThreadsAt_CLIENTINPUTSEND_Framework* obj);
        void boot3_REG_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global(class WriteEnableForThreadsAt_CLIENTINPUTSEND_Framework* obj);
        void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_CLIENTINPUTSEND_Global(class WriteEnableForThreadsAt_CLIENTINPUTSEND_Framework* obj);
        ...
        static class WriteEnableForThreadsAt_CLIENTINPUTSEND_Framework* stat_CONVERT_ObjPtr_to_Class(void* obj);
