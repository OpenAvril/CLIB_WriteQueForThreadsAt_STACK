...
extern "C"
{
    namespace CLIBWriteQueAtClientOutputReceive
    {
        ...
        private:
            ...
            static void stat_REG_boot1_DEFINE_CLIBLaunchQueAtClientOutputReceive_isFlagINSTANTIATED();
            static void stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtClientOutputReceive_isFlagINSTANTIATED();
            static void stat_REG_boot3_INITIALISE_CLIBLaunchQueAtClientOutputReceive_isFlagINSTANTIATED();
            static bool* stat_REG_get_CLIBLaunchQueAtClientOutputReceive_isFlagINSTANTIATED();
        };
    }
}
#endif
