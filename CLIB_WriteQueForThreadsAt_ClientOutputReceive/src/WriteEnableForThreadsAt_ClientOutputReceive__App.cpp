...
#include <iostream>
#include <ostream>
    CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Control* CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::_stat_CLASS_ptr_WriteEnable__Control = NULL;
    ...
    {
        CLASS_boot0_DECLARE_WriteEnableForThreadsAt_ClientOutputReceive();
        CLASS_boot1_DEFINE_WriteEnableForThreadsAt_ClientOutputReceive();
        CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ClientOutputReceive();
    }
    CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::~WriteEnableForThreadsAt_ClientOutputReceive__App()
    {
        delete _stat_CLASS_ptr_WriteEnable__Control;
    }
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::CLASS_boot0_DECLARE_WriteEnableForThreadsAt_ClientOutputReceive()
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::CLASS_boot1_DEFINE_WriteEnableForThreadsAt_ClientOutputReceive()
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ClientOutputReceive()
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::REG_boot0_DECLARE_WriteEnableForThreadsAt_ClientOutputReceive()
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::REG_boot1_DEFINE_WriteEnableForThreadsAt_ClientOutputReceive(CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Framework* obj)
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ClientOutputReceive(CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Framework* obj)
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::REG_boot3_INITIALISE_WriteEnableForThreadsAt_ClientOutputReceive(CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Framework* obj)
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_ClientOutputReceive(CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::dyn_APP_FUNCT_write_End(CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::dyn_APP_FUNCT_write_Start(CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::stat_CLASS_boot1_DEFINE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = NULL;
    }

    void CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::stat_CLASS_boot3_INITIALISE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = new class CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Control();
        while (stat_CLASS_get_ptr_WriteEnable__Control() == NULL) {}
    }
    CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__Control* CLIBWriteQueAtClientOutputReceive::WriteEnableForThreadsAt_ClientOutputReceive__App::stat_CLASS_get_ptr_WriteEnable__Control()
    {
