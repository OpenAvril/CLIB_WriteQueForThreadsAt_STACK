...
class CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework* _ptr_Framework_WriteEnableForThreadsAt_STACK;
...
{
	_ptr_Framework_WriteEnableForThreadsAt_STACK = new class CLIBWriteQueAtSTACK::WriteEnableForThreadsAt_STACK_Framework();
	while (stat_CLASS_get_ptr_Framework() == NULL) {}
}
