#ifndef CLIB_WriteEnableForThreadsAt_STACK_WriteEnableForThreadsAt_STACK_Global_H
#define CLIB_WriteEnableForThreadsAt_STACK_WriteEnableForThreadsAt_STACK_Global_H
extern "C" {
    namespace CLIBWriteQueAtSTACK
    {
        ...
        public:
            ...
            void boot1_REG_DEFINE_WriteEnableForThreadsAt_STACK_Global(class WriteEnableForThreadsAt_STACK_Framework* obj);
            void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_STACK_Global(class WriteEnableForThreadsAt_STACK_Framework* obj);
            void boot3_REG_INITIALISE_WriteEnableForThreadsAt_STACK_Global(class WriteEnableForThreadsAt_STACK_Framework* obj);
            void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_STACK_Global(class WriteEnableForThreadsAt_STACK_Framework* obj);
