...
namespace CLIBWriteQueAtServerInputReceive
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_ServerInputReceive__Control();
        void dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive__Control__dynamicIn(class WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, uint8_t coreId);
        void dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive__Control__dynamicOut(class WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, uint8_t coreId);
        ...
        bool dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_ONE();
        bool dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING();
        bool dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_ONE();
        bool dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING();
        bool dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index();
        bool dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index();
        ...
        void dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_ONE(bool FLAGState);
        void dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING(bool FLAGState);
        void dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_ONE(bool FLAGState);
        void dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING(bool FLAGState);
        ...
        void dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index(uint8_t newValue);
        void dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index(uint8_t newValue);
    private:
        static bool* _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive__FLAG_Control__isWriteStartThreadRELASE_ONE;
        static bool* _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive__FLAG_Control__isWriteStartThreadRELASE_REMAINING;
        static bool* _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive__FLAG_Control__isWriteEndThreadRELASE_ONE;
        static bool* _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive__FLAG_Control__isWriteEndThreadRELASE_REMAINING;
        ...
        static uint8_t* _stat_REG_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index;
        static uint8_t* _stat_REG_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index;
        static void stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_ONE();
        static void stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING();
        static void stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_ONE();
        static void stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING();
        ...
        static void stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index();
        static void stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index();
        static void stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_ONE();
        static void stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING();
        static void stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_ONE();
        static void stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING();
        ...
        static void stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index();
        static void stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index();
        static void stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_ONE();
        static void stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING();
        static void stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_ONE();
        static void stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING();
        ...
        static void stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index();
        static void stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index();
        static bool stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_ONE();
        static bool stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING();
        static bool stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_ONE();
        static bool stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING();
        static bool stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isCurrentThreadRELEASED();
        ...
        static uint8_t* stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index();
        static uint8_t* stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index();
        static void stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_ONE(bool newFLAG);
        static void stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING(bool newFLAG);
        static void stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_ONE(bool newFLAG);
        static void stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING(bool newFLAG);
        static void stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isCurrentThreadRELEASED(bool FLAGState);
        ...
        static void stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteStartThreadId_Index(uint8_t newValue);
        static void stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_WriteEndThreadId_Index(uint8_t newValue);
