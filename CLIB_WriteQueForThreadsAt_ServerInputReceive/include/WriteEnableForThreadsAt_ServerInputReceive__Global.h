#ifndef CLIB_WRITEENABLEFORTHREADSAT_ServerInputReceive_WRITEENABLEFORTHREADSAT_ServerInputReceive__FRAMEWORK__GLOBAL_H
#define CLIB_WRITEENABLEFORTHREADSAT_ServerInputReceive_WRITEENABLEFORTHREADSAT_ServerInputReceive__FRAMEWORK__GLOBAL_H
#include <array>
#include <cstdint>
namespace CLIBWriteQueAtServerInputReceive {
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_ServerInputReceive__Global();
        void dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerInputReceive__Global();
