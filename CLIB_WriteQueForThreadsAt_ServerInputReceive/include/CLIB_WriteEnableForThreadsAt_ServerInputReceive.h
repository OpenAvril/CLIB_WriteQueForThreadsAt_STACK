...
extern "C"
{
    namespace CLIBWriteQueAtServerInputReceive {
        ...
        private:
            static bool CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_APP_FUNCT_Calc_IsAllINSTANTIATED();
            ...
            static bool* CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFLAGINSTANTIATED();
        };
    }
}
#endif
