...
// public.
	void* CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive__App_FUNCT_generate_Program()	{
		...
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_create_CLIB_OpenEpiCentre_Global_and_Settings();
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Global()->dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerInputReceive__Global();
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Global()->dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerInputReceive__Global();
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Global()->dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerInputReceive__Global();
		...
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_create_Architecture();
		std::cout << "started Registers - DEFINE" << std::endl;
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App__Control()->dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerInputReceive__Control(CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework());
		std::cout << "done Registers - DEFINE." << std::endl;
		std::cout << "started Registers - SUBSTANTIATE." << std::endl;
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App__Control()->dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerInputReceive__Control(CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework());
		std::cout << "done Registers - SUBSTANTIATE." << std::endl;
		std::cout << "started Registers - INITIALISE." << std::endl;
		CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App__Control()->dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerInputReceive__Control(CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework());
	...
	void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive__App_FUNCT_write_End(unsigned char* bytes)	{
		if (CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFLAGINSTANTIATED()[3] == false) {
			...
			CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App__Control()->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteEndThreadRELASE_REMAINING(true);
		}
		else {
	...
	void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive__App_FUNCT_write_Start(unsigned char* bytes) {
		if (CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFLAGINSTANTIATED()[4] == false) {
			...
			CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__App__Control()->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive__Control__isWriteStartThreadRELASE_REMAINING(true);
		}
		else {
	...
	bool CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_APP_FUNCT_Calc_IsAllINSTANTIATED() {
		for(int index = 0; index < 5; index++) {
			if (!_stat_REG_FLAG_CLIB_WriteEnableForThreadsAt_ServerInputReceive__isMemberFunctionINSTANTIATED[index]) {
				_stat_REG_FLAG_CLIB_WriteEnableForThreadsAt_ServerInputReceive__isMemberFunctionINSTANTIATED[0] = _stat_REG_FLAG_CLIB_WriteEnableForThreadsAt_ServerInputReceive__isMemberFunctionINSTANTIATED[index];
				break;
			}
		}
	...
	void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_CLASS_boot1_DEFINE_Framework() {
		_stat_REG_ptr_Framework_WriteEnableForThreadsAt_ServerInputReceive = nullptr;
	}
	...
	void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_REG_boot1_DEFINE_CLIBLaunchQueAtServerInputReceive_isFLAGINSTANTIATED() {
		_stat_REG_FLAG_CLIB_WriteEnableForThreadsAt_ServerInputReceive__isMemberFunctionINSTANTIATED = nullptr;
	}
	void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtServerInputReceive_isFLAGINSTANTIATED() {
		...
		while (CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFLAGINSTANTIATED() == nullptr) {}
