...
namespace OpenAvrilCLIBWriteEnableForThreadsAtCLIENTOUTPUTRECIEVE
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global();
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global();
        static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global();
        static void boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global();
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global();
        void boot1_REG_DEFINE_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
        void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
        void boot3_REG_INITIALISE_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
        void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
