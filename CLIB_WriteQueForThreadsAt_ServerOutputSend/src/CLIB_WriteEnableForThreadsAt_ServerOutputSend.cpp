...
// public.
	void* CLIBWriteQueAtServerOutputSend::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_ServerOutputSend__App_FUNCT_generate_Program()	{
		...
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_create_CLIB_OpenEpiCentre_Global_and_Settings();
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__Global()->dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend__Global();
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__Global()->dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerOutputSend__Global();
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__Global()->dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend__Global();
		...
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_create_Architecture();
		std::cout << "started Registers - DEFINE" << std::endl;
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__App__Control()->dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend__Control(CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework());
		std::cout << "done Registers - DEFINE." << std::endl;
		std::cout << "started Registers - SUBSTANTIATE." << std::endl;
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__App__Control()->dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerOutputSend__Control(CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework());
		std::cout << "done Registers - SUBSTANTIATE." << std::endl;
		std::cout << "started Registers - INITIALISE." << std::endl;
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__App__Control()->dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend__Control(CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework());
	...
	bool CLIBWriteQueAtServerOutputSend::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_APP_FUNCT_Calc_IsAllINSTANTIATED() {
		...
		return *CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_REG_get_CLIBLaunchQueAtServerOutputSend_isFLAGINSTANTIATED();
	}
