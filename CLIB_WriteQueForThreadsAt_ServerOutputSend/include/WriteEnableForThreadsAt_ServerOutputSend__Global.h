#ifndef CLIB_WRITEENABLEFORTHREADSAT_ServerOutputSend_WRITEENABLEFORTHREADSAT_ServerOutputSend__FRAMEWORK__GLOBAL_H
#define CLIB_WRITEENABLEFORTHREADSAT_ServerOutputSend_WRITEENABLEFORTHREADSAT_ServerOutputSend__FRAMEWORK__GLOBAL_H
#include <array>
#include <cstdint>
namespace CLIBWriteQueAtServerOutputSend {
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_ServerOutputSend__Global();
        void dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend__Global();
