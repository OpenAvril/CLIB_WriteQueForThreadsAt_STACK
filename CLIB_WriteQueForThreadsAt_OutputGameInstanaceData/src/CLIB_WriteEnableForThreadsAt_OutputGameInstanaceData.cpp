...
// public.
	...
	unsigned char* CLIBWriteQueAtOutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__App_FUNCT_get_flag_isPGM_INSTANTIATED()
	{
		if (CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED()[1] == false) {
			...
			CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED();
	...
	void CLIBWriteQueAtOutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__App_FUNCT_write_End(unsigned char* bytes)
	{
		if (CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED()[4] == false) {
			...
			CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED();
			CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_App_FUNCT_set_flag_isCurrentThreadRELEASED(true);
		}
	}
	...
	{
		if (CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED()[5] == false) {
			...
			CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED()[5] = false;
			CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED();//INSTANTIATE this member function last.
		}
	}
	bool CLIBWriteQueAtOutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_APP_FUNCT_Calc_IsAllINSTANTIATED() {
		for(int index = 0; index < 5; index++) {
			if (_stat_REG_flag_CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__isMemberFunctionINSTANTIATED[index] == false) {
				_stat_REG_flag_CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__isMemberFunctionINSTANTIATED[0] = false;
			}
		}
		return *CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_REG_get_CLIBLaunchQueAtOutputGameInstanaceData_isFlagINSTANTIATED();
	}
	void CLIBWriteQueAtOutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData::CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_App_FUNCT_set_flag_isCurrentThreadRELEASED(bool bytes) {
		return CLIB_WriteEnableForThreadsAt_OutputGameInstanaceData__stat_CLASS_get_ptr_Framework()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_OutputGameInstanaceData__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_OutputGameInstanaceData__App__Control()->dyn_App_FUNCT_set_flag_isCurrentThreadRELEASED(bytes);
	}
