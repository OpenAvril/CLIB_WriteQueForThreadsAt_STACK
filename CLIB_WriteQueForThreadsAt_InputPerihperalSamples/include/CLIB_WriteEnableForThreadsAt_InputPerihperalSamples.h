...
extern "C"
{
    namespace CLIBWriteQueAtInputPerihperalSamples
    {
        ...
        public:
            ...
            static void CLIB_WriteEnableForThreadsAt_InputPerihperalSamples__App_FUNCT_set_flag_isCurrentThreadRELEASED(unsigned char* bytes);
        ...
        private:
            static bool CLIB_WriteEnableForThreadsAt_InputPerihperalSamples__stat_APP_FUNCT_Calc_IsAllINSTANTIATED();
            static void CLIB_WriteEnableForThreadsAt_InputPerihperalSamples__stat_App_FUNCT_set_flag_isCurrentThreadRELEASED(bool bytes);
