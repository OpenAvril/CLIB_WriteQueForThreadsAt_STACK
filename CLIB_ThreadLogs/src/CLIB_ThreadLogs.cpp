...
// public.
	void* CLIB_ThreadLogs::CLIB_ThreadLogs::stat_App_FUNCT_CLIB_ThreadLogs_generate_Program(uint8_t threadId) {
		...
		std::cout << "thread " << threadId << " :: |      OpenAvril : ThreadLogs        |" << std::endl;
	...
	void CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(uint8_t threadId, std::string* stringForLogPrint) {
		CLIBWriteQueAtDataCluster::CLIB_WriteEnableForThreadsAt_DataCluster::CLIB_WriteEnableForThreadsAt_App_FUNCT_write_Start_DataClusterId_ThreadId(threadId, *dataClusterId, CLIBWriteQueAtDataCluster::WriteEnableForThreadsAt_DataCluster_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_DataCluster_Msb_uint8_t_to_MsbByteArray(threadId, threadId));
		if (!stat_REG_get_CLIB_ThreadLogs_array_Of_flag_isINSTANTIATED(threadId)->at(0)) {
			std::cout << "thread " << threadId << " ::  * APP_FUNCT : stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(uint8_t threadId) = " << _stat_REG_flag_CLIB_ThreadLogs_isMemberFunctionINSTANTIATED << std::endl;
	...
	void CLIB_ThreadLogs::CLIB_ThreadLogs::stat_App_FUNCT_CLIB_ThreadLogs_terminate_Program(uint8_t threadId) {
		CLIBWriteQueAtDataCluster::CLIB_WriteEnableForThreadsAt_DataCluster::CLIB_WriteEnableForThreadsAt_App_FUNCT_write_Start_DataClusterId_ThreadId(threadId, *dataClusterId, CLIBWriteQueAtDataCluster::WriteEnableForThreadsAt_DataCluster_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_DataCluster_Msb_uint8_t_to_MsbByteArray(threadId, threadId));		std::cout << "thread " << threadId << " :: exiting LIB :: CLIB_ThreadLogs : CLIB_ThreadLogs : stat_App_FUNCT_CLIB_ThreadLogs_terminate_Program(threadId)." << std::endl;
		if (!stat_REG_get_CLIB_ThreadLogs_array_Of_flag_isINSTANTIATED(threadId)->at(0)) {
...
// private.
	...
	void CLIB_ThreadLogs::CLIB_ThreadLogs::pr_stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(uint8_t threadId, std::string* stringForLogPrint) {
