...
namespace CLIB_ThreadLogs {
    ...
    private:
        ...
        static void stat_PGM_boot1_DEFINE_WriteQueForThreadsAt_WriteQue_DataCluster(uint8_t threadId);
        static void stat_PGM_boot3_INITIALISE_WriteQueForThreadsAt_WriteQue_DataCluster(uint8_t threadId, uint8_t dataClusterId);
        static void stat_PGM_boot4_INSTANTIATE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId);
        static void* stat_PGM_get_ptr_WriteQueForThreadsAt_WriteQue_DataCluster(uint8_t threadId);
    };
};
