...
extern "C" {
    namespace wq {
        class ClusterAccess {
        public:
            static void generateHandles(uint8_t threadId, std::byte MAX_NUMBER_OF_DATA_CLUSTERS, std::list<std::byte> MAX_NUMBER_OF_THREADS_FOR_ACCESS_ARRAY);
        ...
        private:
            ...
            static bool CLIB_ClusterAccess_stat_APP_FUNCT_Calc_IsAllINSTANTIATED(uint8_t threadId, uint8_t dataClusterId);
            ...
            static std::list<class wq::ClusterAccess_Framework*>*  CLIB_ClusterAccess_stat_PGM_get_array_of_ptr_DataCluster(uint8_t threadId);
            static class wq::ClusterAccess_Framework* CLIB_ClusterAccess_stat_PGM_get_ptr_DataCluster(uint8_t threadId, uint8_t dataClusterId);
        };
    }
}
#endif
