...
extern "C" {
    namespace CLIBWriteQueAtDataCluster {
        ...
        private:
            ...
            static void CLIB_WriteEnableForThreadsAt_DataCluster_stat_REG_boot3_INITIALISE_array_of_DataCluster_array_of_isMemberFunctionINSTANTIATED(uint8_t threadId);
