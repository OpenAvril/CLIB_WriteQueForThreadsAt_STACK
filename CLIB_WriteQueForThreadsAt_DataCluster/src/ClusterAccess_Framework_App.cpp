...
#include <iostream>
    ...
    void wq::ClusterAccess_Framework_App::dyn_APP_FUNCT_write_End(uint8_t threadId, wq::ClusterAccess_Framework* obj, uint8_t coreId) {
        ...
        obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_set_FLAG_ClusterAccess_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId, true);
        obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_set_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId, obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_get_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)+1);
        if (obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_get_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId) == static_cast<uint8_t>(obj->dyn_CLASS_get_ptr_ClusterAccess_Global(threadId)->dyn_REG_get_ClusterAccess_number_Of_Implemented_Threads(threadId))) {
            obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_set_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId, 0);
        }
        obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_set_Item_On_list_Of_ClusterAccess_Framework_App_Control_2ibt_FLAG_WriteState(threadId,coreId, obj->dyn_CLASS_get_ptr_ClusterAccess_Global(threadId)->dyn_REG_get_ptr_CONST_ClusterAccess_2bitFLAG_IDLE(threadId));
    ...
    void wq::ClusterAccess_Framework_App::dyn_APP_FUNCT_write_Start(uint8_t threadId, wq::ClusterAccess_Framework* obj, uint8_t coreId)
    {
        ...
        obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_set_FLAG_ClusterAccess_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId, true);
        obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_set_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId, obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_get_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)+1);
        if (obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_get_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId) == static_cast<uint8_t>(obj->dyn_CLASS_get_ptr_ClusterAccess_Global(threadId)->dyn_REG_get_ClusterAccess_number_Of_Implemented_Threads(threadId))) {
            obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_REG_set_FLAG_ClusterAccess_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId, 0);
        }
        obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_APP_FUNCT_ClusterAccess_Framework_App_Control_writeQue_Update(threadId, obj);
        obj->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_CLASS_get_ptr_ClusterAccess_App_Control(threadId)->dyn_APP_FUNCT_ClusterAccess_Framework_App_Control_writeEnable_SortQue(threadId, obj);
