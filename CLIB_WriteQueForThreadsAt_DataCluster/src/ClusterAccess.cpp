...
// public.
	 std::list<void*>* slif::Mutex::generateHandlesMutex(uint8_t threadId, std::byte MAX_NUMBER_OF_DATA_CLUSTERS, std::list<std::byte> MAX_NUMBER_OF_THREADS_FOR_ACCESS_ARRAY) {
		std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_generateAllLibrariesWithin(threadId)." << std::endl;
		...
		std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_generateAllLibrariesWithin(threadId)." << std::endl;
	}
	unsigned char* slif::Mutex::CLIB_ClusterAccess_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(uint8_t threadId, uint8_t dataClusterId)	{
		std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(threadId)." << std::endl;
		bool* result = nullptr;
		...
		*result = true;
		...
		std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(threadId)." << std::endl;
		return ClusterAccess_Framework_Global::stat_APP_CONVERT_ClusterAccess_MsbBoolean_To_MsbByteArray(threadId, *result);
	}
	void slif::Mutex::CLIB_ClusterAccess_App_FUNCT_terminate_Program(uint8_t threadId, uint8_t dataClusterId)	{
		std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_terminate_Program(threadId)." << std::endl;
		if (!CLIB_ClusterAccess_stat_REG_get_array_of_isMemberFunctionINSTANTIATED(threadId)->at(0)) {
		...
		std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_terminate_Program(threadId)." << std::endl;
	}
	void slif::Mutex::unlock(uint8_t threadId, uint8_t dataClusterId, unsigned char* bytes) {
		std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_write_End(threadId)." << std::endl;
		if (!CLIB_ClusterAccess_stat_REG_get_array_of_isMemberFunctionINSTANTIATED(threadId)->at(0)) {

			CLIB_ClusterAccess_stat_PGM_get_ptr_DataCluster(threadId, dataClusterId)->dyn_CLASS_get_ptr_ClusterAccess_App(threadId)->dyn_APP_FUNCT_write_End(threadId, slif::Mutex::CLIB_ClusterAccess_stat_PGM_get_ptr_DataCluster(threadId, dataClusterId), ClusterAccess_Framework_Global::stat_APP_CONVERT_ClusterAccess_MsbByteArray_To_Msbuint8_t(threadId, bytes));
		...
		std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_write_End(threadId)." << std::endl;

	}
	void slif::Mutex::lock(uint8_t threadId, uint8_t dataClusterId, unsigned char* bytes) {
		std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_write_Start(threadId)." << std::endl;
		if (!CLIB_ClusterAccess_stat_REG_get_array_of_isMemberFunctionINSTANTIATED(threadId)->at(0)) {
		...
		std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_write_Start(threadId)." << std::endl;
	}
// private.
	void* slif::Mutex::CLIB_ClusterAccess_App_FUNCT_generate_Program(uint8_t threadId, uint8_t dataClusterId)	{
		std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_generate_Program(threadId)." << std::endl;
		...
		std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : ClusterAccess_App_FUNCT_generate_Program(threadId)." << std::endl;
		return (void*)CLIB_ClusterAccess_stat_PGM_get_ptr_DataCluster(threadId, dataClusterId);
	}
	bool slif::Mutex::CLIB_ClusterAccess_stat_APP_FUNCT_Calc_IsAllINSTANTIATED(uint8_t threadId) {
	...
	void slif::Mutex::CLIB_ClusterAccess_stat_PGM_boot1_DEFINE_array_of_ptr_DataCluster_Framework(uint8_t threadId) {
	 	std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_PGM_boot1_DEFINE_array_of_ptr_DataCluster_Framework(threadId)." << std::endl;
		stat_REG_ptr_ClusterAccess_array_of_ptr_DataCluster = nullptr;
	 	std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_PGM_boot1_DEFINE_array_of_ptr_DataCluster_Framework(threadId)." << std::endl;
	}
	void slif::Mutex::CLIB_ClusterAccess_stat_PGM_boot2_SUBSTANTIATE_array_of_ptr_DataCluster_Framework(uint8_t threadId) {
	 	std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_PGM_boot2_SUBSTANTIATE_array_of_ptr_DataCluster_Framework(threadId)." << std::endl;
	 	...
	 	for (uint8_t dataClusterId = 0; dataClusterId < static_cast<uint8_t>(stat_REG_ptr_ClusterAccess_array_of_ptr_DataCluster->size()); dataClusterId++) {
	 		...
	 		*temp = slif::Mutex::CLIB_ClusterAccess_App_FUNCT_generate_Program(threadId, dataClusterId);
	 	}
	 	std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_PGM_boot2_SUBSTANTIATE_array_of_ptr_DataCluster_Framework(threadId)." << std::endl;
	 }
	void slif::Mutex::CLIB_ClusterAccess_stat_PGM_boot3_INITIALISE_array_of_ptr_DataCluster_Framework(uint8_t threadId, std::byte MAX_NUMBER_OF_DATA_CLUSTERS) {
	 	std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_PGM_boot3_INITIALISE_array_of_ptr_DataCluster_Framework(threadId)." << std::endl;
	 	auto DEFAULT = CLIB_ClusterAccess_stat_PGM_get_array_of_ptr_DataCluster(threadId)->begin();
	 	...
	 	std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_PGM_boot3_INITIALISE_array_of_ptr_DataCluster_Framework(threadId)." << std::endl;
	}
	void slif::Mutex::CLIB_ClusterAccess_stat_REG_boot2_SUBSTANTIATE_array_of_isMemberFunctionINSTANTIATED(uint8_t threadId) {
	 	std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_REG_boot2_SUBSTANTIATE_array_of_isMemberFunctionINSTANTIATED(threadId)." << std::endl;
		...
		for (uint8_t memberFunctionId = 0; memberFunctionId < static_cast<uint8_t>(CLIB_ClusterAccess_stat_REG_get_array_of_isMemberFunctionINSTANTIATED(threadId)->size()); memberFunctionId++) {
	 	...
	 	std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_REG_boot2_SUBSTANTIATE_array_of_isMemberFunctionINSTANTIATED(threadId)." << std::endl;
	}
	void slif::Mutex::CLIB_ClusterAccess_stat_REG_boot3_INITIALISE_array_of_isMemberFunctionINSTANTIATED(uint8_t threadId) {
	 	std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_REG_boot3_INITIALISE_array_of_isMemberFunctionINSTANTIATED(threadId)." << std::endl;
		for (uint8_t memberFunctionId = 0; memberFunctionId < static_cast<uint8_t>(CLIB_ClusterAccess_stat_REG_get_array_of_isMemberFunctionINSTANTIATED(threadId)->size()); memberFunctionId++) {
			CLIB_ClusterAccess_stat_REG_get_array_of_isMemberFunctionINSTANTIATED(threadId)->at(memberFunctionId) = true;
		}
	 	std::cout << "thread " << std::to_string(threadId) << " :: exiting LIB :: CLIB_WriteQueForThreadsAt_DataCluster : ClusterAccess : CLIB_ClusterAccess_stat_REG_boot3_INITIALISE_array_of_isMemberFunctionINSTANTIATED(threadId)." << std::endl;
	}
	std::array<bool, 5>* slif::Mutex::CLIB_ClusterAccess_stat_REG_get_array_of_isMemberFunctionINSTANTIATED(uint8_t threadId) {
		return stat_REG_ptr_ClusterAccess_array_of_DataCluster_array_of_isMemberFunctionINSTANTIATED;
	}
	std::list<void*>* slif::Mutex::CLIB_ClusterAccess_stat_PGM_get_array_of_ptr_DataCluster(uint8_t threadId) {
	...
	class CLIB_WriteQueForThreadsAt_DataCluster::ClusterAccess_Framework* slif::Mutex::CLIB_ClusterAccess_stat_PGM_get_ptr_DataCluster(uint8_t threadId, uint8_t dataClusterId)	{
		...
		return reinterpret_cast<CLIB_WriteQueForThreadsAt_DataCluster::ClusterAccess_Framework*>(*temp);
	}